...
def main():
    ...
    app.layout = dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
                html.Div(id='overall_sentiment', children=[html.H4(id='overall_sentiment_text', children="Overall Sentiment: N/A")]),
            ], width=12),
        ]),
        dcc.Interval(
    ...
    def update_graph(ticker, timeframe):
        ...
        if ticker not in list_of_tickers:
            return go.Figure(layout=dict(xaxis=dict(visible=False), yaxis=dict(visible=False))), display_error_message("Please enter a valid stock ticker"), "N/A"
        ...
        try:
            ...
            go.Figure(layout=dict(xaxis=dict(visible=False), yaxis=dict(visible=False))), display_error_message("Error fetching stock data. Please try again or enter a different stock ticker"), "N/A"
        ...
        news_div = html.Div([
            html.H4("News Articles:", className="news-title"),
            *[html.Div(className='news_article', children=[
                html.Img(src=article["image"], width="100", height="100", className="news-image"),
                dcc.Link(article["title"], href=article["url"], target="_blank", className="news-title"),
        ...
        return fig, news_div, html.H4(overall_sentiment_text, style={"color": overall_sentiment_color})
